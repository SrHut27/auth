...
const transporter = nodemailer.createTransport({
    service: 'email',
    auth: {
        user: 'youremailhere@email.com',
        pass: 'your pass word here'
    }
});
...
function sendPasswordResetEmail(email, resetToken){
    const mailOptions = {
        ...
        <div style="font-family: Arial, sans-serif; font-size: 16px; color: #333;">
            ...
            <a href="http://localhost:8000/auth/reset_password/${resetToken}" style="display: inline-block; padding: 10px 20px; background-color: #00642c; color: #fff; text-decoration: none; border-radius: 5px;">Redefinir Senha</a>
